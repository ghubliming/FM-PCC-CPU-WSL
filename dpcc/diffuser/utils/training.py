    ...
    def __init__(
        ...
        if train_test_split == 1:
            self.train_dataloader = cycle(torch.utils.data.DataLoader(
                self.dataset, batch_size=train_batch_size, num_workers=2, shuffle=True, pin_memory=False
            ))
        else:
            ...
            self.train_dataloader = cycle(torch.utils.data.DataLoader(
                train_dataset, batch_size=train_batch_size, num_workers=2, shuffle=True, pin_memory=False
            ))
            self.test_dataloader = cycle(torch.utils.data.DataLoader(
                test_dataset, batch_size=train_batch_size, num_workers=2, shuffle=True, pin_memory=False
            ))
